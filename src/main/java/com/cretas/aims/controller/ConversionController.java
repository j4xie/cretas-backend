...
public class ConversionController {
    ...
    public ApiResponse<List<ConversionDTO>> getConversionsByMaterial(
            @PathVariable @Parameter(description = "工厂ID") String factoryId,
            @PathVariable @Parameter(description = "原材料类型ID") Integer materialTypeId) {
    ...
    public ApiResponse<List<ConversionDTO>> getConversionsByProduct(
            @PathVariable @Parameter(description = "工厂ID") String factoryId,
            @PathVariable @Parameter(description = "产品类型ID") Integer productTypeId) {
    ...
    public ApiResponse<ConversionDTO> getConversionRate(
            @PathVariable @Parameter(description = "工厂ID") String factoryId,
            @RequestParam @Parameter(description = "原材料类型ID") Integer materialTypeId,
            @RequestParam @Parameter(description = "产品类型ID") Integer productTypeId) {
