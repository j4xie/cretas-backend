...
public interface MaterialBatchRepository extends JpaRepository<MaterialBatch, Integer> {
     ...
     * 根据供应商查找批次
     */
    List<MaterialBatch> findByFactoryIdAndSupplierId(String factoryId, Integer supplierId);
     ...
     * 根据ID和工厂ID查找
     */
    Optional<MaterialBatch> findByIdAndFactoryId(Integer id, String factoryId);

    /**
     * 根据工厂ID和材料类型ID查找
     */
    List<MaterialBatch> findByFactoryIdAndMaterialTypeId(String factoryId, Integer materialTypeId);
