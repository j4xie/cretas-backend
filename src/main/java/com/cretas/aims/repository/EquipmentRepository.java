 ...
 */
@Repository
public interface EquipmentRepository extends JpaRepository<FactoryEquipment, Integer> {

    /**
     * 根据ID和工厂ID查找设备
     */
    Optional<FactoryEquipment> findByIdAndFactoryId(Integer id, String factoryId);
    ...
    boolean hasUsageRecords(@Param("equipmentId") Integer equipmentId);
