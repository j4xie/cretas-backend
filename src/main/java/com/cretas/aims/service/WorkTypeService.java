...
public interface WorkTypeService {
     ...
     * @return 工作类型详情
      */
    WorkTypeDTO getWorkTypeById(String factoryId, Integer id);
     /**
     * 更新工作类型
     * @param dto 更新数据
     * @return 更新后的工作类型
      */
    WorkTypeDTO updateWorkType(String factoryId, Integer id, WorkTypeDTO dto);
     /**
     * 删除工作类型
      */
    void deleteWorkType(String factoryId, Integer id);
     /**
     * 切换工作类型状态
      */
    WorkTypeDTO toggleWorkTypeStatus(String factoryId, Integer id);
     /**
     * 初始化默认工作类型
      */
