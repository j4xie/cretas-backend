...
public interface CustomerService {
     ...
     * 更新客户
      */
    CustomerDTO updateCustomer(String factoryId, Integer customerId, CreateCustomerRequest request);
     /**
     * 删除客户
      */
    void deleteCustomer(String factoryId, Integer customerId);
     /**
     * 获取客户详情
      */
    CustomerDTO getCustomerById(String factoryId, Integer customerId);
     /**
     * 获取客户列表（分页）
      */
     ...
     * 激活/停用客户
      */
    CustomerDTO toggleCustomerStatus(String factoryId, Integer customerId, Boolean isActive);
     /**
     * 更新客户评级
      */
    CustomerDTO updateCustomerRating(String factoryId, Integer customerId, Integer rating, String notes);
     /**
     * 更新客户信用额度
      */
    CustomerDTO updateCreditLimit(String factoryId, Integer customerId, BigDecimal creditLimit);
     /**
     * 更新客户当前余额
      */
    CustomerDTO updateCurrentBalance(String factoryId, Integer customerId, BigDecimal balance);
     /**
     * 获取客户统计信息
      */
    Map<String, Object> getCustomerStatistics(String factoryId, Integer customerId);
     /**
     * 获取客户购买历史
      */
    List<Map<String, Object>> getCustomerPurchaseHistory(String factoryId, Integer customerId);
     /**
     * 检查客户代码是否存在
      */
