...
public interface ProductionPlanService {
     ...
     * 更新生产计划
      */
    ProductionPlanDTO updateProductionPlan(String factoryId, Integer planId, CreateProductionPlanRequest request);
     /**
     * 删除生产计划
      */
    void deleteProductionPlan(String factoryId, Integer planId);
     /**
     * 获取生产计划详情
      */
    ProductionPlanDTO getProductionPlanById(String factoryId, Integer planId);
     /**
     * 获取生产计划列表（分页）
      */
     ...
     * 开始生产
      */
    ProductionPlanDTO startProduction(String factoryId, Integer planId);
     /**
     * 完成生产
      */
    ProductionPlanDTO completeProduction(String factoryId, Integer planId, BigDecimal actualQuantity);
     /**
     * 取消生产计划
      */
    void cancelProductionPlan(String factoryId, Integer planId, String reason);
     /**
     * 暂停生产
      */
    ProductionPlanDTO pauseProduction(String factoryId, Integer planId);
     /**
     * 恢复生产
      */
    ProductionPlanDTO resumeProduction(String factoryId, Integer planId);
     /**
     * 更新实际成本
      */
    ProductionPlanDTO updateActualCosts(String factoryId, Integer planId,
     ...
     * 分配原材料批次
      */
    void assignMaterialBatches(String factoryId, Integer planId, List<Integer> batchIds);
     /**
     * 记录材料消耗
      */
    void recordMaterialConsumption(String factoryId, Integer planId, Integer batchId, BigDecimal quantity);
     /**
     * 获取生产计划统计
      */
