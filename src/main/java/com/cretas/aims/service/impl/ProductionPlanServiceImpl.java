...
public class ProductionPlanServiceImpl implements ProductionPlanService {
    ...
    @Override
    @Transactional
    public ProductionPlanDTO updateProductionPlan(String factoryId, Integer planId, CreateProductionPlanRequest request) {
    ...
    @Override
    @Transactional
    public void deleteProductionPlan(String factoryId, Integer planId) {
        ProductionPlan plan = productionPlanRepository.findById(planId)
                .orElseThrow(() -> new ResourceNotFoundException("生产计划", "id", planId));
    ...
    @Override
    @Transactional
    public ProductionPlanDTO startProduction(String factoryId, Integer planId) {
        ProductionPlan plan = productionPlanRepository.findById(planId)
                .orElseThrow(() -> new ResourceNotFoundException("生产计划", "id", planId));
    ...
    @Override
    @Transactional
    public ProductionPlanDTO completeProduction(String factoryId, Integer planId, BigDecimal actualQuantity) {
        ProductionPlan plan = productionPlanRepository.findById(planId)
                .orElseThrow(() -> new ResourceNotFoundException("生产计划", "id", planId));
    ...
    @Override
    @Transactional
    public void cancelProductionPlan(String factoryId, Integer planId, String reason) {
        ProductionPlan plan = productionPlanRepository.findById(planId)
                .orElseThrow(() -> new ResourceNotFoundException("生产计划", "id", planId));
    ...
    @Override
    @Transactional
    public ProductionPlanDTO pauseProduction(String factoryId, Integer planId) {
        ProductionPlan plan = productionPlanRepository.findById(planId)
                .orElseThrow(() -> new ResourceNotFoundException("生产计划", "id", planId));
    ...
    @Override
    @Transactional
    public ProductionPlanDTO resumeProduction(String factoryId, Integer planId) {
        ProductionPlan plan = productionPlanRepository.findById(planId)
                .orElseThrow(() -> new ResourceNotFoundException("生产计划", "id", planId));
    ...
    @Override
    @Transactional
    public ProductionPlanDTO updateActualCosts(String factoryId, Integer planId,
    ...
    @Override
    @Transactional
    public void assignMaterialBatches(String factoryId, Integer planId, List<Integer> batchIds) {
        ProductionPlan plan = productionPlanRepository.findById(planId)
                .orElseThrow(() -> new ResourceNotFoundException("生产计划", "id", planId));
    ...
    @Override
    @Transactional
    public void recordMaterialConsumption(String factoryId, Integer planId, Integer batchId, BigDecimal quantity) {
        ProductionPlan plan = productionPlanRepository.findById(planId)
                .orElseThrow(() -> new ResourceNotFoundException("生产计划", "id", planId));
     ...
     * 分配原材料批次到生产计划
     */
    private void assignMaterialBatchesToPlan(ProductionPlan plan, List<Integer> batchIds) {
