...
public class WorkTypeServiceImpl implements WorkTypeService {
    ...
    @Override
    public WorkTypeDTO getWorkTypeById(String factoryId, Integer id) {
    ...
    @Override
    @Transactional
    public WorkTypeDTO updateWorkType(String factoryId, Integer id, WorkTypeDTO dto) {
    ...
    @Override
    @Transactional
    public void deleteWorkType(String factoryId, Integer id) {
    ...
    @Override
    @Transactional
    public WorkTypeDTO toggleWorkTypeStatus(String factoryId, Integer id) {
