...
public class TimeClockServiceImpl implements TimeClockService {
    ...
    @Override
    @Transactional
    public TimeClockRecord clockIn(String factoryId, Integer userId, String location, String device) {
        ...
        Optional<TimeClockRecord> existingRecord = timeClockRecordRepository
                .findByFactoryIdAndUserIdAndClockDate(factoryId, userId, today);
    ...
    @Override
    @Transactional
    public TimeClockRecord clockOut(String factoryId, Integer userId) {
    ...
    @Override
    @Transactional
    public TimeClockRecord breakStart(String factoryId, Integer userId) {
    ...
    @Override
    @Transactional
    public TimeClockRecord breakEnd(String factoryId, Integer userId) {
    ...
    @Override
    public Map<String, Object> getClockStatus(String factoryId, Integer userId) {
    ...
    @Override
    public PageResponse<TimeClockRecord> getClockHistory(String factoryId, Integer userId,
        ...
        Pageable pageable = org.springframework.data.domain.PageRequest.of(
                ...
                pageRequest.getSize(),
                Sort.by(Sort.Direction.DESC, "clockDate", "clockInTime")
        );
        
        Page<TimeClockRecord> page = timeClockRecordRepository
                .findByFactoryIdAndUserIdAndClockDateBetween(factoryId, userId, startDate, endDate, pageable);
    ...
    @Override
    public TimeClockRecord getTodayRecord(String factoryId, Integer userId) {
    ...
    public TimeClockRecord editClockRecord(String factoryId, Long recordId, TimeClockRecord record,
        ...
        existingRecord.setEditedBy(editedBy);
    ...
    @Override
    public Map<String, Object> getAttendanceStatistics(String factoryId, Integer userId,
                                                        LocalDate startDate, LocalDate endDate) {
        ...
        List<TimeClockRecord> records = timeClockRecordRepository
                .findByFactoryIdAndUserIdAndClockDateBetween(factoryId, userId, startDate, endDate);
    ...
    public Map<String, Object> getDepartmentAttendance(String factoryId, String department, LocalDate date) {
        ...
        List<TimeClockRecord> records = timeClockRecordRepository
                .findByFactoryIdAndDepartmentAndClockDate(factoryId, department, date);
