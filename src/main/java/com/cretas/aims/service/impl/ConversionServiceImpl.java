...
public class ConversionServiceImpl implements ConversionService {
    ...
    @Override
    @Transactional(readOnly = true)
    public List<ConversionDTO> getConversionsByMaterial(String factoryId, Integer materialTypeId) {
    ...
    @Override
    @Transactional(readOnly = true)
    public List<ConversionDTO> getConversionsByProduct(String factoryId, Integer productTypeId) {
    ...
    @Override
    @Transactional(readOnly = true)
    public ConversionDTO getConversionRate(String factoryId, Integer materialTypeId, Integer productTypeId) {
    ...
    @Override
    @Transactional(readOnly = true)
    public List<MaterialRequirement> calculateMaterialRequirement(String factoryId, Integer productTypeId,
    ...
    @Override
    @Transactional(readOnly = true)
    public List<ProductOutput> calculateProductOutput(String factoryId, Integer materialTypeId,
    ...
    public ConversionStatistics getStatistics(String factoryId) {
        ...
        // 材料和产品类型统计
        Set<Integer> materialTypes = new HashSet<>();
