...
public class ProductTypeServiceImpl implements ProductTypeService {
    ...
    public ProductTypeDTO createProductType(String factoryId, ProductTypeDTO dto) {
        ...
        productType.setCreatedBy(1); // TODO: 从当前用户获取
    ...
    @Override
    @Transactional
    public ProductTypeDTO updateProductType(String factoryId, Integer id, ProductTypeDTO dto) {
    ...
    @Override
    @Transactional
    public void deleteProductType(String factoryId, Integer id) {
    ...
    @Override
    public ProductTypeDTO getProductTypeById(String factoryId, Integer id) {
    ...
    @Override
    @Transactional
    public void updateProductTypesStatus(String factoryId, List<Integer> ids, Boolean isActive) {
