...
public interface ConversionService {
     ...
     * 根据原材料类型获取转换率列表
      */
    List<ConversionDTO> getConversionsByMaterial(String factoryId, Integer materialTypeId);
     /**
     * 根据产品类型获取转换率列表
      */
    List<ConversionDTO> getConversionsByProduct(String factoryId, Integer productTypeId);
     /**
     * 获取特定原材料和产品的转换率
      */
    ConversionDTO getConversionRate(String factoryId, Integer materialTypeId, Integer productTypeId);
     /**
     * 计算原材料需求量
     ...
     * @return 所需原材料列表及数量
      */
    List<MaterialRequirement> calculateMaterialRequirement(String factoryId, Integer productTypeId,
     ...
     * @return 可产出产品列表及数量
      */
    List<ProductOutput> calculateProductOutput(String factoryId, Integer materialTypeId,
    ...
    class MaterialRequirement {
        ...
        public void setMaterialTypeId(Integer materialTypeId) { this.materialTypeId = materialTypeId; }
