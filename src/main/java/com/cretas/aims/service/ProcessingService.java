...
public interface ProcessingService {
     ...
     * 开始生产
      */
    ProductionBatch startProduction(String factoryId, Long batchId, Integer supervisorId);
     /**
     * 暂停生产
      */
    ProductionBatch pauseProduction(String factoryId, Long batchId, String reason);
     /**
     * 完成生产
      */
    ProductionBatch completeProduction(String factoryId, Long batchId, BigDecimal actualQuantity,
                                       BigDecimal goodQuantity, BigDecimal defectQuantity);
     /**
     * 取消生产
      */
    ProductionBatch cancelProduction(String factoryId, Long batchId, String reason);
     /**
     * 获取批次详情
      */
    ProductionBatch getBatchById(String factoryId, Long batchId);
     /**
     * 获取批次列表
      */
     ...
     * 获取批次时间线
      */
    List<Map<String, Object>> getBatchTimeline(String factoryId, Long batchId);
    // ========== 原材料管理 ==========
     /**
     * 原材料接收
      */
     ...
     * 更新原材料信息
      */
    MaterialBatch updateMaterialReceipt(String factoryId, Long batchId, MaterialBatch updates);
     /**
     * 原材料消耗记录
      */
    void recordMaterialConsumption(String factoryId, Long productionBatchId,
                                   List<Map<String, Object>> consumptions);
    // ========== 质量检验 ==========
     /**
     * 提交质检记录
      */
    Map<String, Object> submitInspection(String factoryId, Long batchId, Map<String, Object> inspection);
     /**
     * 获取质检记录
      */
    PageResponse<Map<String, Object>> getInspections(String factoryId, Long batchId, PageRequest pageRequest);
     /**
     * 获取质检统计
      */
     ...
     * 记录设备使用
      */
    void recordEquipmentUsage(String factoryId, Long batchId, Integer equipmentId,
     ...
     * 获取批次成本分析
      */
    Map<String, Object> getBatchCostAnalysis(String factoryId, Long batchId);
     /**
     * 重新计算批次成本
      */
    ProductionBatch recalculateBatchCost(String factoryId, Long batchId);
     /**
     * AI成本分析建议（旧版本，基于规则）
      */
    Map<String, Object> getAICostAnalysis(String factoryId, Long batchId);
     ...
     * @return AI分析结果
     */
    Map<String, Object> analyzeWithAI(String factoryId, Long batchId,
