...
public interface SupplierService {
     ...
     * 更新供应商
      */
    SupplierDTO updateSupplier(String factoryId, Integer supplierId, CreateSupplierRequest request);
     /**
     * 删除供应商
      */
    void deleteSupplier(String factoryId, Integer supplierId);
     /**
     * 获取供应商详情
      */
    SupplierDTO getSupplierById(String factoryId, Integer supplierId);
     /**
     * 获取供应商列表（分页）
      */
     ...
     * 激活/停用供应商
      */
    SupplierDTO toggleSupplierStatus(String factoryId, Integer supplierId, Boolean isActive);
     /**
     * 更新供应商评级
      */
    SupplierDTO updateSupplierRating(String factoryId, Integer supplierId, Integer rating, String notes);
     /**
     * 更新供应商信用额度
      */
    SupplierDTO updateCreditLimit(String factoryId, Integer supplierId, BigDecimal creditLimit);
     /**
     * 获取供应商统计信息
      */
    Map<String, Object> getSupplierStatistics(String factoryId, Integer supplierId);
     /**
     * 获取供应商供货历史
      */
    List<Map<String, Object>> getSupplierHistory(String factoryId, Integer supplierId);
     /**
     * 检查供应商代码是否存在
      */
