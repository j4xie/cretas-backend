...
public interface ProductTypeService {
     ...
     * 更新产品类型
      */
    ProductTypeDTO updateProductType(String factoryId, Integer id, ProductTypeDTO dto);
     /**
     * 删除产品类型
      */
    void deleteProductType(String factoryId, Integer id);
     /**
     * 获取产品类型详情
      */
    ProductTypeDTO getProductTypeById(String factoryId, Integer id);
     /**
     * 获取产品类型列表（分页）
      */
     ...
     * 批量更新状态
      */
    void updateProductTypesStatus(String factoryId, List<Integer> ids, Boolean isActive);
     /**
     * 检查产品编码是否存在
      */
